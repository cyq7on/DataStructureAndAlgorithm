 ...
 *
 * Once you pay the cost, you can either climb one or two steps. You need to getRes minimum cost to reach the top of the getFloor, and you can either start from the step with index 0, or the step with index 1.
 *
 * Example 1:
 * Input: cost = [10, 15, 20]
 * Output: 15
